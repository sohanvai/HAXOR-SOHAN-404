...
module.exports.onStart = async ({ api, event, args, usersData }) => {
  ...
  try {
    if (!args[0]) {
      const ran = ["জা্ঁন্ঁ গো্ঁ ভা্ঁলো্ঁবা্ঁসা্ঁর্ঁ আ্ঁরে্ঁক্ঁ না্ঁম্ঁ তু্ঁমি্ঁ জা্ঁন্ঁ 😌🫶🏻", "জা্ঁন্ঁ গো্ঁ এ্ঁম্ঁবি্ঁ ভ্ঁরে্ঁ দি্ঁবা্ঁ 🥺🫶🏻", "আ্ঁমা্ঁকে্ঁ ডা্ঁকা্ঁর্ঁ আ্ঁগে্ঁ আ্ঁমা্ঁর্ঁ ব্ঁস্ঁ আ্ঁদ্ঁনা্ঁন্ঁকে্ঁ আ্ঁই্ঁ লা্ঁভ্ঁ ই্ঁউ্ঁ 😘🙈", "type !mira hi"];
